...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Salvează token în storage-ul corect în funcție de checkbox
      setToken(response.access_token, keepLoggedIn)
  ...
  const inputStyle: React.CSSProperties = {
    ...
    boxSizing: 'border-box', fontFamily: 'var(--font-text)',
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ textAlign: 'center', marginBottom: 28 }}>
          <img
            src="/logo.png" alt="TutorTrack"
            style={{ height: 48, width: 'auto', margin: '0 auto', filter: 'brightness(0) invert(1)', opacity: 0.95 }}
            onError={e => {
        ...
        <div style={{ textAlign: 'center', marginBottom: 28 }}>
          <h1 style={{
            ...
            letterSpacing: '-0.025em', color: 'white', margin: '0 0 6px',
          }}>
        ...
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
          ...
          {mode === 'register' && (
            <div>
              ...
              <input
                ...
                placeholder="Ion Popescu" required style={inputStyle}
          ...
          <div>
            ...
            <input
              ...
              placeholder="ion@email.com" required style={inputStyle}
              onFocus={e => (e.currentTarget.style.borderColor = 'rgba(255,255,255,0.5)')}
              onBlur={e => (e.currentTarget.style.borderColor = 'rgba(255,255,255,0.2)')}
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              placeholder="Minim 6 caractere" required minLength={6} style={inputStyle}
              onFocus={e => (e.currentTarget.style.borderColor = 'rgba(255,255,255,0.5)')}
              onBlur={e => (e.currentTarget.style.borderColor = 'rgba(255,255,255,0.2)')}
            />
          </div>
          ...
          {mode === 'register' && (
            <div>
              ...
              <input
                ...
                placeholder="+373 69 000 000" style={inputStyle}
                onFocus={e => (e.currentTarget.style.borderColor = 'rgba(255,255,255,0.5)')}
                onBlur={e => (e.currentTarget.style.borderColor = 'rgba(255,255,255,0.2)')}
              />
            </div>
          ...
          {/* ── Ține-mă conectat (doar la login) ── */}
          {mode === 'login' && (
            <label style={{
              ...
              <div
                ...
                style={{
                  ...
                  border: `1.5px solid ${keepLoggedIn ? 'var(--accent)' : 'rgba(255,255,255,0.35)'}`,
                  background: keepLoggedIn ? 'var(--accent)' : 'transparent',
          ...
          <button
            ...
            style={{
              ...
              marginTop: 6, fontFamily: 'var(--font-text)',
